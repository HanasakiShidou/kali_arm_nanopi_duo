...
extras="bluetooth libnss-systemd network-manager psmisc wpasupplicant "
...
#mkdir -p ${basedir}/kali-${architecture}/boot/overlays/ #不知道有什么用
#cp arch/arm/boot/dts/allwinner/overlays/*.dtb ${basedir}/kali-${architecture}/boot/overlays/
make mrproper
cd ${basedir}
